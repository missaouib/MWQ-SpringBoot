...
<div class="wrapper main_page" style="background-color: white;">
    ...
    <div class="row" style=" background-color: rgba(255, 152, 0, 0.17);">
        <div class="text-center" style="padding: 20px 0;">
            <div class="col-xs-4">
                <p style="color: rgb(136, 136, 136);">可使用金额</p>
                <p style="font-size: 20px; color: rgb(16, 16, 16);">200</p>
            </div>
            <div class="col-xs-4"></div>
            <div class="col-xs-4" style="padding-top: 1rem;">
                <button class="user_setting_button" style="background-color: rgb(255, 229, 97); border-radius: 5px; padding: 3px 21px;">充值</button>
            </div>
        </div>
    </div>
    <div class="row text-center" style="color: rgba(79, 79, 79, 0.72); padding: 1rem 0;">
        <div class="col-xs-4">收益项</div>
        <div class="col-xs-4">金额</div>
        <div class="col-xs-4">时间</div>
    </div>
    <div class="row text-center" style="color: rgba(79, 79, 79, 0.72); padding: 1rem 0;">
        <div class="col-xs-4">在线充值</div>
