                                    ...
                                    <form class="form-horizontal">
                                        <fieldset>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea class="form-control resize_vertical" id="content" name="content" placeholder="请输入文章内容。。。" rows="5"></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="col-md-3"></div>
            ...
            function submit() {
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        if (result.status) {
                            if (result.message == 'fail to upload image')
                                swal("提示", "上传图片失败。", "warning");
                            else
                                swal("成功！", "", "success");
